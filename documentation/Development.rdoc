...
The source code of _pandora_ is hosted in a central Subversion repository at
...
The options will be required when {file:Testing deploying a new version of pandora},
